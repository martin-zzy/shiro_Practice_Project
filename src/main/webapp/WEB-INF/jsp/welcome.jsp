...
#showAnnouncement{box-shadow: 10px 10px 5px #888888;top:15%;left:15%;position:fixed;z-index:111;width:70%;height:70%;display: none;border:1px solid #0080ff;background: #ffffff;}
</style>
